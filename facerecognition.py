...
#time.sleep(5) #for the time delay
...
#	print(len(faces))
	...
	for face in faces:
		...
		cv2.rectangle(frame, (x,y), (x+w, y+h), (0,255,0), 2) # Drawing a box around the face
		cv2.putText(frame, preds[0], (x,y), cv2.FONT_HERSHEY_SIMPLEX, 2, (0,255,0), 2)
